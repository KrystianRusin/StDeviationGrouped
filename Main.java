...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int     groupNum          = INVALID;
        int     maxInterval       = INVALID;
        int     minInterval       = INVALID;
            ...
            if (scanSystemIn.hasNextInt()){
                ...
                switch (methodSelection){
                    ...
                    case 3:{ // Grouped Values
                        ...
                        System.out.println("Please enter the Min Value for your groups");
                        CalcSD.setMin(scanSystemIn.nextInt());

                        System.out.println("Please enter the Max Value for your groups");
